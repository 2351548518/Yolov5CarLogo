...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='', help='models/yolov5scarlogo.yaml')
    parser.add_argument('--data', type=str, default=ROOT / 'data/VOCcarlogo.yaml', help='data/VOCcarlogo.yaml')
